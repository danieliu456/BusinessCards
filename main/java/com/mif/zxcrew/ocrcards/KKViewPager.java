 ...
 * KKViewPager.java
 *
 * Purpose: Set up scrollable page size;
 *
 * KKViewPager() sets up settings for scrollable pages;
 *
 * dp2px() converts dp to pixels;
 *
 * setAnimationEnabled() sets animation enabled;
 *
 * setFadeEnabled() sets fade enabled;
 *
 * setFadeFactor() sets fade factor with given value;
 *
 * setPageMargin() sets page margins with given margin Pixel size;
 *
 * transformPage() sets up scrollable page size, margins, position;
 *
